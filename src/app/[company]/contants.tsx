export const PRO_TIPS = [
  ...
  (company: string) => (
    <>
      ...
      <br /> If you can&apos;t find a recruiter&apos;s email from an extension
      like Apollo, you can try manually entering their names into these 3 email
  ...
  (company: string) => (
    <>
      Once you&apos;re familiar with {company}&apos;s values, you can include a
      sentence or two about how you and your experiences might align with their
      values. Don&apos;t force it, you&apos;ll have time to demonstrate your
      culture fit in the interview. <br />
      <br />
